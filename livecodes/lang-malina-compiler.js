...
(() => {
  ...
  var acornUrl = /* @__PURE__ */ getUrl("acorn@8.12.1/dist/acorn.js");
  var astringUrl = /* @__PURE__ */ getUrl("astring@1.8.6/dist/astring.min.js");
  var cjs2esUrl = /* @__PURE__ */ getUrl("cjs2es@1.1.1/dist/cjs2es.browser.js");
  var csstreeUrl = /* @__PURE__ */ getUrl("css-tree@2.3.1/dist/csstree.js");
...
export { ${tokens.join(", ")} };`;
  ...
  // src/livecodes/languages/malina/lang-malina-compiler.ts
  self.createMalinaCompiler = () => {
    self.importScripts(acornUrl, astringUrl, csstreeUrl, cjs2esUrl);
    self["css-tree"] = self.csstree;
    self.importScripts(malinaBaseUrl + "malina.js");
    return async (code, { config }) => {
      const processedCode = await compileAllBlocks(code, config, {
        removeEnclosingTemplate: true
      });
      try {
        const result = await self.malina.compile(processedCode, {
          exportDefault: false,
          inlineTemplate: true,
          autoSubscribe: true,
          name: "Component",
