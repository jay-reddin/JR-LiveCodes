...
(() => {
  ...
  var cppWasmBaseUrl = /* @__PURE__ */ getUrl("@chriskoch/cpp-wasm@1.0.2/");

  // src/livecodes/languages/cpp-wasm/lang-cpp-wasm-script.ts
  var getWorkerSrc = async (baseUrl) => {
    try {
      ...
      const patchedContent = content.replace("https://cdn.jsdelivr.net/npm/@chriskoch/cpp-wasm@1.0.1/", baseUrl).replace("https://cdn.jsdelivr.net/npm/@chriskoch/cpp-wasm/memfs", baseUrl + "memfs");
      return `
var window = self;
