...
(() => {
  ...
  var rescriptCdnBaseUrl = /* @__PURE__ */ getUrl("https://cdn.rescript-lang.org/v11.1.2/");

  // src/livecodes/languages/rescript/lang-rescript-formatter.ts
  var createRescriptFormatter = (baseUrl, language) => {
    if (!self.rescript_compiler) {
      importScripts(getAbsoluteUrl(rescriptCdnBaseUrl + "compiler.js", baseUrl));
    }
    const compiler = self.rescript_compiler.make();
  ...
  self.createRescriptFormatter = createRescriptFormatter;
})();
